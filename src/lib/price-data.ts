...
const RAW: [string, number, number, number, number, number, number, number][] =
  [
    ...
    ["iPhone 11", 64, 5000, 3800, 2800, 1600, 900, 1800],
    ["iPhone 11", 128, 6000, 4700, 3600, 2000, 1100, 1950],
    ["iPhone 11", 256, 7000, 5600, 4300, 2400, 1300, 2100],
    ["iPhone 11 Pro", 64, 8000, 6800, 5200, 3000, 1700, 2500],
    ["iPhone 11 Pro", 256, 9000, 7700, 5900, 3400, 1900, 2700],
    ["iPhone 11 Pro Max", 64, 9500, 8100, 6200, 3600, 2000, 2800],
    ["iPhone 11 Pro Max", 256, 10500, 9000, 6900, 4000, 2200, 3000],
    ["iPhone 12 Mini", 64, 6500, 5500, 4200, 2400, 1400, 2200],
    ["iPhone 12 Mini", 128, 7500, 6400, 4900, 2800, 1600, 2400],
    ["iPhone 12", 64, 7500, 6400, 4900, 2800, 1600, 2400],
    ["iPhone 12", 128, 8500, 7300, 5600, 3200, 1800, 2600],
    ["iPhone 12", 256, 9500, 8200, 6300, 3600, 2000, 2800],
    ["iPhone 12 Pro", 128, 12000, 10300, 8000, 4600, 2600, 3300],
    ["iPhone 12 Pro", 256, 13500, 11600, 9000, 5200, 2900, 3600],
    ["iPhone 12 Pro", 512, 15000, 12900, 10000, 5800, 3200, 3900],
    ["iPhone 12 Pro Max", 128, 14000, 12000, 9300, 5400, 3000, 3700],
    ["iPhone 12 Pro Max", 256, 15500, 13300, 10300, 6000, 3300, 3000],
    ["iPhone 12 Pro Max", 512, 17000, 14600, 11300, 6600, 3600, 3300],
    ["iPhone 13 Mini", 128, 10000, 8600, 6700, 3900, 2200, 2500],
    ["iPhone 13 Mini", 256, 11500, 9900, 7700, 4500, 2500, 2800],
    ["iPhone 13", 128, 14000, 10300, 8000, 4600, 2600, 3300],
    ["iPhone 13", 256, 15500, 11600, 9000, 5200, 2900, 3600],
    ["iPhone 13", 512, 17000, 12900, 10000, 5800, 3200, 3900],
